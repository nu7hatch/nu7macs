...
(defun color-theme-zenburn ()
  ...
  (color-theme-install
	...
	`(zenburn-primary-1 ((t (:foreground "#ffcc77" :weight bold))))
	...
	'(zenburn-fringe
	  ((t (:background "#252525"))))
	'(zenburn-linum
	  ((t (:background "#2A2A2A" :foreground "#666666"))))
	...
	'(fringe ((t (:inherit zenburn-fringe))))
	'(header-line ((t (:inherit zenburn-highlight-damp
			    :box (:color "#2e3330" :line-width 2)))))
	'(mode-line ((t (:foreground "#acbc90" :background "#0e4AB0"
			  :box (:color "#0e4AB0" :line-width 2)))))
	'(mode-line-inactive ((t (:background "#3e4340" :foreground "#88b090"
				   :box (:color "#3e4340" :line-width 2)))))
